...
import { AccountBalanceWallet, AddCircle, Verified, Link as LinkIcon } from '@mui/icons-material';
        ...
        <Grid container spacing={3} sx={{ mb: 3 }}>
            ...
            <Card>
              <CardContent>
                <Box display="flex" alignItems="center">
                  <AccountBalanceWallet sx={{ fontSize: 40, color: '#006B3F', mr: 2 }} />
                  <Box>
          ...
          <Grid item xs={12} sm={4}>
            <Card>
              <CardContent>
                <Box display="flex" alignItems="center">
                  <Verified sx={{ fontSize: 40, color: '#FCD116', mr: 2 }} />
                  <Box>
                    <Typography variant="h4" sx={{ fontWeight: 'bold' }}>
                      {stats.tokens_minted}
                    </Typography>
          ...
          <Grid item xs={12} sm={4}>
            <Card>
              <CardContent>
                <Box display="flex" alignItems="center">
                  <LinkIcon sx={{ fontSize: 40, color: '#CE1126', mr: 2 }} />
                  <Box>
                    <Typography variant="h4" sx={{ fontWeight: 'bold' }}>
                      {stats.latest_block}
                    </Typography>
